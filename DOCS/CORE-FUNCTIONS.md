...
This page documents the core retirement planning functions.
...
Array with [RRSP at retirement, TFSA at retirement, Total, Monthly Income]
...
Projected annual pension (number)
